export const cardDatabase = [
    ...
    { name: "Aero Predator", str: 4, dmg: 3, con: 8, cost: 1, modulateEffect: "draw2", skillText: "Modulate: Draw 2 cards." },
    ...
    { name: "Chop Chop Headless", str: 1, dmg: 1, con: 1, cost: 1, transformEffect: "chopChopBuff", transformCost: 3, skillText: "Transform (Cost 3): +2 STR and +1 CON to all your echoes this round."  },
    ...
    { name: "Dwarf Cassowary", str: 1, dmg: 1, con: 1, cost: 1, transformEffect: "strBuff1", skillText: "Transform: Increase all your Echoes STR by 1 this round." },
    { name: "Fission Junrock", str: 1, dmg: 1, con: 1, cost: 1, transformEffect: "discoverCost1", skillText: "Transform: Show 3st 1-cost echoes from the deck. Put one in your hand, the rest is shuffled back." },
    ...
    { name: "Carapace", str: 1, dmg: 1, con: 1, cost: 1, skillText: "During battle, gains +3 DMG." },
    { name: "Hoartoise", str: 1, dmg: 1, con: 1, cost: 1, transformEffect: "hoartoiseBlock", skillText: "Transform: (1) Blocks 3 damage from the next attack against you."},
    { name: "Diamond Claw", str: 1, dmg: 1, con: 1, cost: 1, modulateEffect: "draw2", skillText: "Modulate: Draw 2 cards." },
    { name: "Abyssal Patricius", str: 1, dmg: 1, con: 1, cost: 1, skillText: "During battle, gains +2 STR and +2 CON for 4 rounds." },
    { name: "Cyan Feather", str: 1, dmg: 1, con: 1, cost: 1, transformEffect: "cyanFeatherHeal", transformCost: 3, skillText: "Transform (Cost 3): Heal 6 HP." },
];
